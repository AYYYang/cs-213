    ...
    switch (insOpCode.get()) {
      ...
      case 0x6: // ALU ................... 6-sd
        switch (insOp0.get()) {
          ...
          case 0xf: // gpc ............... 6Fpd  r[d] ← pc + (o == p*2)
      ...
      case 0x8: // br a .................. 8-pp  pc ← (A = pc + pp*2)
        pc.set(pc.get() + insOpImm.get() * 2);
        break;

      case 0x9: // beq rs, a ............. 9cpp pc ← (A = pc + pp*2) if r[c]==0
        if (reg.get(insOp0.get()) == 0)
          pc.set(pc.get() + insOpImm.get() *2);
        break;

      case 0xa: // bg rs, a .............. Acpp  pc ← (A = pc + pp*2) if r[c]>0
        if (reg.get(insOp0.get()) > 0)
          pc.set(pc.get() + insOpImm.get() *2);
        break;
      ...
      case 0xc: // j o(rr) ............... Ctpp pc ← r[t] + (o == pp*2)
